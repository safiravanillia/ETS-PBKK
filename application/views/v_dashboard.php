...
<body class="hold-transition skin-blue-light sidebar-mini">
    ...
    if ($status==null){
        ...
        $status1="Sudah";
        $status2=$status->p_status;
        $ta = $this->db->get_where("ta", array('p_id'=> $status->p_id))->row();
        if ($ta==null){
            $ta1="Belum";
            $ta2="Tidak Ada"; 
        } else{
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?php echo base_url('pengajuan'); ?>"><i class="fa fa-circle-o"></i> Pengajuan proposal</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            ...
                            <a href="<?php echo base_url('pengajuan'); ?>" class="small-box-footer">Klik disini<i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                            ...
                            <a href="<?php echo base_url('status'); ?>" class="small-box-footer">Klik disini <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xs-6">
                        <!-- small box -->
                        <div class="small-box bg-yellow">
                            ...
                            <a href="<?php echo base_url('pengajuanta'); ?>" class="small-box-footer">Klik disini <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-red">
                            ...
                            <a href="<?php echo base_url('statusta'); ?>" class="small-box-footer">Klik disini <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                </div>
