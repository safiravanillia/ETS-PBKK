...
<head>
    ...
    <title>informatikaTA | Pengajuan proposal</title>
...
<body class="hold-transition skin-blue-light sidebar-mini">
    ...
    $status =$this->db->get_where("proposal", array('m_id'=> $datalogin->m_id))->row();
    ...
    ?>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?php echo base_url('pengajuan'); ?>"><i class="fa fa-circle-o"></i> Pengajuan
                                    proposal</a></li>
        ...
        <div class="content-wrapper">
            ...
            if($status!=null && $status->p_status!="Ditolak"){echo'
            <div class="pad margin no-print">
                <div class="callout callout-success" style="margin-bottom: 0!important;">
                    <h4><i class="fa fa-info"></i> Catatan:</h4>
                    Proposal sudah diajukan, silahkan <b><a href="status">cek status proposal</a></b> Anda
                </div>
            </div>';
            } elseif($status==null || $status->p_status=="Ditolak"){
                echo'
                <!-- Main content -->
            <section class="content">
                ...
                <div class="box box-primary color-palette-box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-edit"></i> Lengkapi form pengajuan proposal berikut</h3>
                    </div>
                    <div class="box-body">
                        <!-- form start -->
                        <form role="form" action="pengajuan/tambah" method="post"  enctype="multipart/form-data" >
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <!-- /.row -->
                                <div class="form-group">
                                    <input name="m_id" type="hidden" value="'.$datalogin->m_id.'" " class="form-control" id="exampleInputEmail1">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="p_deskripsi" class="form-control" rows="3" placeholder="Tuliskan ringkasan proposal"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">File Proposal</label>
                                    <input name="p_file" type="file" id="exampleInputFile">
