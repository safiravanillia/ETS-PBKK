    ...
    ?>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="<?php echo base_url('tanggalsidang'); ?>"><i class="fa fa-pencil"></i> <span>Plotting sidang</span></a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                Plotting sidang<small>(status sidang <span class="badge bg-blue">Tunggu</span>)</small>
                </h1>
                <ol class="breadcrumb">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Plotting Sidang</h4>
                            </div>
                            <div class="modal-body">
                                <div class="box-body">
                                    <div class="row">
                                    <form action="<?php echo base_url(). 'tanggalsidang/update/'.$p->p_id; ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Judul</label>
                                        <input name="t_tanggal" type="datetime-local" class="form-control" min= id="exampleInputEmail1"
                                       required>
                                    </div>       
                                    <div class="form-group">
                                                <label>Dosen Penguji 1</label>
                                                <select name="t_penguji1" class="form-control select2" style="width: 100%;">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="t_penguji2" class="form-control select2" style="width: 100%;">
                                                        <?php foreach($dosbing->result() as $d){ ?>
                                                        <option value="<?php echo' '.$d->d_nama.' ';?>"> <?php echo' '.$d->d_nama.' ';?></option>
                                                        <?php } ?>
                                                    </select>
