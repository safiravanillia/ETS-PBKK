...
<head>
    ...
    <title>informatikaTA | Data proposal</title>
...
<body class="hold-transition skin-blue-light sidebar-mini">
    ...
    $proposal = $this->db->query("SELECT * FROM mahasiswa as m, proposal as p where m.m_id = p.m_id;");
    ?>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="<?php echo base_url('data'); ?>"><i class="fa fa-book"></i> <span>Data proposal</span></a></li>
                    <li><a href="<?php echo base_url('verifikasi'); ?>"><i class="fa fa-pencil"></i> <span>Verifikasi
                                proposal</span></a></li>
                </ul>
            </section>
            <!-- /.sidebar -->
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php foreach($proposal->result() as $p){ ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url().'data/download/'.$p->p_file;?>">Download file</a></td>
                                    ...
                                    echo ' <span class="badge bg-red">Ditolak</span>'; }?></td>
                    </div>
                    <!-- /.box-body -->
                    </tr>
                    <?php } ?>
