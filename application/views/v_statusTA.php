...
<head>
    ...
    <title>informatikaTA | Status tugas akhir</title>
...
<body class="hold-transition skin-blue-light sidebar-mini">
    ...
    $proposal = $this->db->query("SELECT * FROM proposal as p where p.m_id = $id_login;");
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class=" treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url('pengajuan'); ?>"><i class="fa fa-circle-o"></i> Pengajuan
                                    proposal</a></li>
                            <li ><a href="<?php echo base_url('status'); ?>"><i class="fa fa-circle-o"></i> Status proposal</a>
                            </li>
                        </ul>
                    </li>
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li ><a href="<?php echo base_url('pengajuanta'); ?>"><i class="fa fa-circle-o"></i> Pengajuan tugas akhir</a></li>
                            <li class="active"><a href="<?php echo base_url('statusta'); ?>"><i class="fa fa-circle-o"></i> Status tugas akhir</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Tugas AKhir</li>
                    <li class="active">Status tugas akhir</li>
                </ol>
            </section>
            <?php if($ta== null){?>
            <div class="pad margin no-print">
                <div class="callout callout-danger" style="margin-bottom: 0!important;">
                    ...
                    Tugas akhir belum diajukan, silahkan <b><a href="pengajuanta">ajukan tugas akhir</a></b> Anda
                </div>
            </div>
            <?php }else{ ?>
            ...
            <div class="pad margin no-print">
                <div class="callout callout-warning" style="margin-bottom: 0!important;">
                    <h4><i class="fa fa-info"></i> Catatan:</h4>
                    Harap selalu memantau perubahan <b>status tugas akhir</b> Anda
                </div>
            </div>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td> : <?php if($ta->t_status=="Tunggu"){
                                    ...
                                    echo' <span class="badge bg-yellow">Proses Sidang '; 
                                    echo date("d/m/Y H:m", strtotime($ta->t_tanggal) );
                                    echo' WIB </span>';
                                 }elseif($ta->p_status=="Selesai"){
